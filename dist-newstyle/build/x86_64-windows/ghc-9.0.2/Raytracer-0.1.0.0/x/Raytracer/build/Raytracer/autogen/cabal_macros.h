...
/* package simple-vec3-0.6.0.1 */
#ifndef VERSION_simple_vec3
#define VERSION_simple_vec3 "0.6.0.1"
#endif /* VERSION_simple_vec3 */
#ifndef MIN_VERSION_simple_vec3
#define MIN_VERSION_simple_vec3(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  6 || \
  (major1) == 0 && (major2) == 6 && (minor) <= 0)
#endif /* MIN_VERSION_simple_vec3 */
